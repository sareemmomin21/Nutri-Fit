...
export default function OverviewPage({ userId }) {
  ...
  const fetchOverview = useCallback(async () => {
    ...
    try {
      const [streakRes, badgesRes, activityRes, friendBadgesRes, statsRes] =
        await Promise.all([
  ...
  return (
    <div>
      ...
      <div style={cardStyle}>
        <div style={sectionHeaderStyle}>
          <FaNewspaper /> Friend Activity Feed
        </div>
        {activityFeed.length === 0 ? (
          ...
          >
            ...
            >
              When your friends complete challenges or earn badges, they'll
              appear here!
            </div>
          </div>
        ) : (
      ...
      <div style={cardStyle}>
        ...
        >
          ...
          >
            ...
            <div
              style={{ fontSize: "20px", fontWeight: "700", color: "#0369a1" }}
            >
          ...
          >
            ...
            <div
              style={{ fontSize: "20px", fontWeight: "700", color: "#15803d" }}
            >
              {stats.totalWorkouts}
            </div>
          ...
          >
            ...
            <div
              style={{ fontSize: "20px", fontWeight: "700", color: "#a16207" }}
            >
