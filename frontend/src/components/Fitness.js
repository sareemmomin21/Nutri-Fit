  ...
  const handleCreateCustomWorkout = async (customWorkoutData) => {
    try {
      const response = await fetch(
        "${process.env.REACT_APP_API_URL}/api/create_custom_workout",
        {
          method: "POST",
...
export default function Fitness() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const response = await fetch(
        "${process.env.REACT_APP_API_URL}/api/get_fitness_dashboard",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchWorkoutRecommendations = async () => {
    try {
      ...
      const response = await fetch(
        "${process.env.REACT_APP_API_URL}/api/get_workout_recommendations",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ user_id: userId }),
  ...
  const fetchWorkoutPlan = async () => {
    try {
      ...
      const response = await fetch(
        "${process.env.REACT_APP_API_URL}/api/get_workout_plan",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ user_id: userId }),
  ...
  const fetchWorkoutHistory = async () => {
    try {
      ...
      const response = await fetch(
        "${process.env.REACT_APP_API_URL}/api/get_workout_history",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const fetchFitnessGoals = async () => {
    try {
      ...
      const response = await fetch(
        "${process.env.REACT_APP_API_URL}/api/get_fitness_goals",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ user_id: userId }),
  ...
  const fetchRecoveryInfo = async () => {
    try {
      const response = await fetch(
        "${process.env.REACT_APP_API_URL}/api/get_recovery_recommendations",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ user_id: userId }),
  ...
  const completeWorkout = async (workoutData) => {
    try {
      const response = await fetch(
        "${process.env.REACT_APP_API_URL}/api/complete_workout",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
  ...
  const addFitnessGoal = async (goalData) => {
    try {
      const response = await fetch(
        "${process.env.REACT_APP_API_URL}/api/add_fitness_goal",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
